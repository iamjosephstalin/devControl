...
import { IntegrationType, INTEGRATION_CONFIG, createIntegration } from "@/lib/integrations"
...
export function CreateIntegrationDialog() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      alert(`Failed to create integration: ${error.message}`)
    } finally {
      setIsCreating(false)
    }
  }
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-md max-h-[90vh] overflow-hidden">
        <DialogHeader>
          ...
          <DialogDescription>
            Connect a new external service to your account
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 max-h-[60vh] overflow-y-auto">
          <div>
            ...
            <Select onValueChange={(value) => setType(value as IntegrationType)}>
        ...
        <div className="flex flex-col sm:flex-row gap-2 pt-4 border-t">
          <Button
            ...
            className="flex-1"
          >
            {isCreating ? "Creating..." : "Connect Integration"}
          </Button>
